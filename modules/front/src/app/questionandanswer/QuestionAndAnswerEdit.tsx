...
import { Answer } from "../../cuba/entities/testing_Answer";
...
@injectMainStore
@observer
class QuestionAndAnswerEditComponent extends React.Component<
  Props & WrappedComponentProps
> {
  dataInstance = instance<QuestionAndAnswer>(QuestionAndAnswer.NAME, {
    view: "questionAndAnswer-view",
    loadImmediately: false
  });

  @observable questionsDc: DataCollectionStore<Question> | undefined;

  @observable answersDc: DataCollectionStore<Answer> | undefined;

  @observable updated = false;
  @observable formRef: React.RefObject<Form> = React.createRef();
  reactionDisposers: IReactionDisposer[] = [];

  fields = ["correct", "question", "answer"];
  ...
  loadAssociationOptions = () => {
    ...
    if (this.props.mainStore != null) {
      ...
      this.questionsDc = loadAssociationOptions(
        QuestionAndAnswer.NAME,
        "question",
        Question.NAME,
      ...
      this.answersDc = loadAssociationOptions(
        QuestionAndAnswer.NAME,
        "answer",
        Answer.NAME,
        getAttributePermission,
  ...
  isNewEntity = () => {
    return this.props.entityId === QuestionAndAnswerManagement.NEW_SUBPATH;
  };

  render() {
    if (this.updated) {
      return <Redirect to={QuestionAndAnswerManagement.PATH} />;
    }
    ...
    return (
      <Card className="narrow-layout">
        <Form onSubmit={this.handleSubmit} layout="vertical" ref={this.formRef}>
          ...
          <Field
            entityName={QuestionAndAnswer.NAME}
            propertyName="question"
            form={this.props.form}
            formItemOpts={{ style: { marginBottom: "12px" } }}
            optionsContainer={this.questionsDc}
          ...
          <Field
            ...
            form={this.props.form}
            formItemOpts={{ style: { marginBottom: "12px" } }}
            optionsContainer={this.answersDc}
            getFieldDecoratorOpts={{
              rules: [{ required: true }]
            }}
          />
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={QuestionAndAnswerManagement.PATH}>
  ...
  componentDidMount() {
    if (this.isNewEntity()) {
      this.dataInstance.setItem(new QuestionAndAnswer());
    } else {
...
export default injectIntl(
  ...
  })(QuestionAndAnswerEditComponent)
);