...
> {
  dataInstance = instance<Question>(Question.NAME, {
    view: "_local",
  ...
  isNewEntity = () => {
    return this.props.entityId === QuestionManagement.NEW_SUBPATH;
  };

  render() {
    if (this.updated) {
      return <Redirect to={QuestionManagement.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        <Form onSubmit={this.handleSubmit} layout="vertical" ref={this.formRef}>
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={QuestionManagement.PATH}>
  ...
  componentDidMount() {
    if (this.isNewEntity()) {
      this.dataInstance.setItem(new Question());
    } else {
