...
@injectMainStore
@observer
class AnswerEditComponent extends React.Component<
  Props & WrappedComponentProps
> {
  dataInstance = instance<Answer>(Answer.NAME, {
    view: "_local",
  ...
  isNewEntity = () => {
    return this.props.entityId === AnswerManagement.NEW_SUBPATH;
  };

  render() {
    if (this.updated) {
      return <Redirect to={AnswerManagement.PATH} />;
    }
  ...
  componentDidMount() {
    if (this.isNewEntity()) {
      this.dataInstance.setItem(new Answer());
    } else {
